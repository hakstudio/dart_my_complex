...
abstract class ComplexConstant implements Complex {
  ...
  ComplexConstant._intern(
      this._real, this._imaginary, this._modulus, this._argument)
      : super() {
  ...
  Complex operator /(Complex other) =>
      other._divideComplexPolar(_polar).inverse;
